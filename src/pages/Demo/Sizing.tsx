          ...
          <tbody className="align-baseline">
            ...
            <tr>
              ...
              <td
                ...
                className="py-2 pl-2 font-mono text-xs leading-6 text-indigo-600 whitespace-pre dark:text-indigo-300 border-t border-slate-100 dark:border-slate-400/10"
              >
                width: 1rem;<span className="text-indigo-400"> /* 16px */</span>
              </td>
            </tr>
            <tr>
              <td
            ...
            <tr>
              ...
              <td
                ...
                className="py-2 pl-2 font-mono text-xs leading-6 text-indigo-600 whitespace-pre dark:text-indigo-300 border-t border-slate-100 dark:border-slate-400/10"
              >
                width: 2rem;<span className="text-indigo-400"> /* 32px */</span>
              </td>
            </tr>
            <tr>
              <td
            ...
            <tr>
              ...
              <td
                ...
                className="py-2 pl-2 font-mono text-xs leading-6 text-indigo-600 whitespace-pre dark:text-indigo-300 border-t border-slate-100 dark:border-slate-400/10"
              >
                width: 3rem;<span className="text-indigo-400"> /* 48px */</span>
              </td>
            </tr>
            <tr>
              <td
            ...
            <tr>
              ...
              <td
                ...
                className="py-2 pl-2 font-mono text-xs leading-6 text-indigo-600 whitespace-pre dark:text-indigo-300 border-t border-slate-100 dark:border-slate-400/10"
              >
                width: 4rem;<span className="text-indigo-400"> /* 64px */</span>
              </td>
            </tr>
            <tr>
              <td
              ...
              <td
                ...
                className="py-2 pl-2 font-mono text-xs leading-6 text-indigo-600 whitespace-pre dark:text-indigo-300 border-t border-slate-100 dark:border-slate-400/10"
              >
                width: 5rem;<span className="text-indigo-400"> /* 80px */</span>
              </td>
            </tr>
            <tr>
              <td
              ...
              <td
                ...
                className="py-2 pl-2 font-mono text-xs leading-6 text-indigo-600 whitespace-pre dark:text-indigo-300 border-t border-slate-100 dark:border-slate-400/10"
              >
                width: 6rem;<span className="text-indigo-400"> /* 96px */</span>
              </td>
            </tr>
            <tr>
              <td
